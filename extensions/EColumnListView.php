...
class EColumnListView extends CListView {
	...
	public function renderItems() {
		...
		if (($n = count($data)) > 0) {
			...
			// Initialize table
			echo CHtml::openTag('table',array('style'=>'width:100%')) . CHtml::openTag('tr');
			...
			foreach ($data as $i => $item) {
				...
				// Open cell
				echo CHtml::openTag('td', array('style' => 'width:' . (int)$width . '%; vertical-align:top; padding-right: 20px;'));
