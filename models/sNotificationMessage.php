...
class sNotificationMessage extends BaseModel
{
    ...
    public function rules()
    {
        return array(
			...
			array('expire, alert_after_date, alert_before_date', 'numerical', 'integerOnly'=>true),
            array('alert_after_date, alert_before_date, group_id, link', 'safe'),
    ...
    public static function getUnreadNotifications()
    {
        ...
        $criteria1->condition='reads.username is null';
