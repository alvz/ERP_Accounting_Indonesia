...
class hVacancyApplicant extends BaseModel
{
	...
	public static function getTopRecentInterview() {
		...
		foreach ($models as $model) {
			$returnarray[] = array('id' => $model->id, 'label' => $model->applicant->applicant_name." - ".$model->vacancy->vacancytitle, 'icon'=>'list-alt', 'url' => array('/m1/hVacancy/interviewDetail','id'=>$model->id));
		}
