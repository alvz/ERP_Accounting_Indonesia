...
<?php foreach ($dataProvider->getData() as $data) { ?>
	...
	<div class="span8">
		<h4 style="padding-bottom:4px;border-bottom-style:solid;border-color:grey;border-width:1px;">
			...
			$data->vacancy->vacancytitle." - ".$data->vacancy->company_name,Yii::app()->createUrl('/m1/hVacancy/interviewDetail',
			array('id'=>$data->id))); ?>
		...
		<?php 
			...
			<?php echo CHtml::activeTextArea($model,'comment',array('rows'=>5, 'class'=>'span8')); ?>		
