<?php $this->widget('TbGridView', array(
		...
		'dataProvider'=>gSelection::model()->search('psikotestresult',true),
		'enableSorting'=>false,
			...
			array(
				...
				'value'=> function($data){
					return CHtml::tag('div', array(), CHtml::link($data->candidate_name,Yii::app()->createUrl("/m1/gBss/RecruitmentView",array("id"=>$data->id))))
						. CHtml::tag('div', array('style'=>'color: #999; font-size: 11px'), 'Psychotest Result')
						. CHtml::tag('div', array('style'=>'font-size: 11px'), $data->psychotest_status->getWorkflowResult());
				}
			),
			'for_position',
			array(
