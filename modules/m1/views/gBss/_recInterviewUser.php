<?php $this->widget('TbGridView', array(
		...
		'dataProvider'=>gSelection::model()->search('interviewuser',true),
		'enableSorting'=>false,
			...
			array(
				...
				'value'=> function($data){
					return CHtml::tag('div', array(), CHtml::link($data->candidate_name,Yii::app()->createUrl("/m1/gBss/RecruitmentView",array("id"=>$data->id))))
						. CHtml::tag('div', array('style'=>'color: #999; font-size: 11px'), 'User Interview')
						. CHtml::tag('div', array('style'=>'font-size: 11px'), $data->userinterview_status->getWorkflowResult());
				}
			),
			'for_position',
			array(
