...
<?php
/* @var $this GRecruitmentProgressController */
/* @var $model gRecruitmentProgress */
...
<?php $form=$this->beginWidget('TbActiveForm', array(
	...
	<?php echo $form->errorSummary($model); ?>
		...
		<div class="control-group">
			...
			<div class="controls">
				<?php 
				echo $form->dropDownList($model, 'workflow_id', gParamSelection::levelDropdownBss(),
						array(
								'empty'=>'Select Process:',
								'ajax' => array(
										'type'=>'POST',
										'url'=>CController::createUrl('/m1/gRecruitment/workflowUpdate'),
		...
		<?php //echo $form->dropDownListRow($model,'workflow_id',sParameter::items('cRecruitmentProcess')); ?>
		<?php echo $form->textFieldRow($model,'workflow_date'); ?>
		<?php echo $form->textFieldRow($model,'workflow_by',array('class'=>'span3')); ?>
		<?php //echo $form->dropDownListRow($model,'workflow_result_id',sParameter::items('cRecruitmentResult')); ?>
