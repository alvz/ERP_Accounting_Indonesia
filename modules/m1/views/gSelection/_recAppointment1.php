<?php $this->widget('TbGridView', array(
		'id'=>'g-recruitment1-grid',
		'dataProvider'=>gSelection::model()->search('appointment1'),
		'enableSorting'=>false,
		...
		'columns'=>array(
			...
			array(
				...
				'value'=> function($data){
					return CHtml::tag('div', array(), CHtml::link($data->candidate_name,Yii::app()->createUrl("/m1/gSelection/view",array("id"=>$data->id))))
						. CHtml::tag('div', array('style'=>'color: #999; font-size: 11px'), 'Tomorrow Appointment')
			...
			//'invitation_status.workflow_date',
			//'birthdate',
			//'quick_background',
			//'work_experience',
			//'sallary_expectation',
