		...
		$this->widget('bootstrap.widgets.TbTabs', array(
			...
			'tabs'=>array(
				...
				array('id'=>'tab3','label'=>'Appointment', 'items'=>array(
					array('id'=>'tab3a','label'=>'Today','content'=>$this->renderPartial("_recAppointment", array(), true)),
					array('id'=>'tab3b','label'=>'Tomorrow','content'=>$this->renderPartial("_recAppointment1", array(), true)),
					array('id'=>'tab3c','label'=>'Today + 2','content'=>$this->renderPartial("_recAppointment2", array(), true)),
					array('id'=>'tab3d','label'=>'Today + 3','content'=>$this->renderPartial("_recAppointment3", array(), true)),
				)),
