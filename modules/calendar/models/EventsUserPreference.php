...
class EventsUserpreference extends CActiveRecord
{
	...
	{
		return 's_events_user_preference';
	}
	...
	{
		return array(
				'user_id' => Yii::t('CalendarModule.EventsUserPreference', 'User'),
				'mobile' => Yii::t('CalendarModule.EventsUserPreference', 'Mobile'),
				'mobile_alert' => Yii::t('CalendarModule.EventsUserPreference', 'Mobile Alert'),
				'email' => Yii::t('CalendarModule.EventsUserPreference', 'Email'),
				'email_alert' => Yii::t('CalendarModule.EventsUserPreference', 'Email Alert'),
		);
	}
